...
const MetterAnimation = () => {
  useEffect(() => {
    // Pehle se mojood canvas check karo
    if (document.querySelector("#wrapper-canvas canvas")) {
  ...
  return (
    <div className=" opacity-40 absolute inset-0 hidden md:block overflow-hidden" id="wrapper-canvas"></div>
  );
};

export default MetterAnimation;
